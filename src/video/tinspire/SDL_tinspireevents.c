...
void NSP_InitOSKeymap(_THIS)
{
	...
	sdlk_keymap[NSP_KEY_QUES] =	SDLK_UNKNOWN;
	...
	sdlk_keymap[NSP_KEY_EXP] =	SDLK_UNKNOWN;
	sdlk_keymap[NSP_KEY_GTHAN] =	SDLK_UNKNOWN;
